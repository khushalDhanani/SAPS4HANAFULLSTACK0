...
| 2, 9, 30, 33, 34, 35, 45 | **Open** | Unchanged: FI tile label, ZFRT/FERT scope, "Due Orders" counts schedule lines, GR outage = 404, GR quantity 0 on failed read, GR lists `[]` on error, queue count 0 on error. |
